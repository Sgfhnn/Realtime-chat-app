...
export default function ChatInterface() {
    ...
    return (
        <div className="flex h-[calc(100vh-4rem)] bg-gray-800 rounded-lg shadow-xl overflow-hidden border border-gray-700">
            {/* Sidebar - Users List */}
            ...
            <div className="flex-1 flex flex-col bg-gray-900">
                {selectedUser ? (
                        ...
                        <div className="p-4 bg-gray-800 border-t border-gray-700">
                            <form onSubmit={handleSendMessage} className="flex space-x-2">
                                <input
                                    ...
                                    className="flex-1 rounded-full border border-gray-600 bg-gray-700 text-white px-4 py-2 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder-gray-400"
                                />
                                <button
                                    type="submit"
                    ...
                    <div className="flex-1 flex items-center justify-center bg-gray-900 flex-col text-gray-500">
                        ...
                        <h3 className="text-xl font-semibold text-gray-300">Welcome to Chat App</h3>
                        <p className="mt-2 text-gray-400">Select a user from the sidebar to start messaging</p>
                    </div>
                )}
            </div>
        </div>
